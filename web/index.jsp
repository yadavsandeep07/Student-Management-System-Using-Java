...
try
{
	...
	if(request.getParameter("btn_login")!=null)
	{
		...
		pstmt=con.prepareStatement("select * from adminlogin where email=? AND password=?");
...
<body>
    <div style="background-image: url('../css/slogin.jpg');">
  ...
  <form class="form-register" method="post" name="myform" onsubmit="return validate();">
					...
					%>
                         ...
                         <p>Username</p>
                         <input type="text" name="txt_email" id="email" placeholder="Enter Username" required>
			    ...
			    <input type="submit" name="btn_login" value="Login">
                             <p align="center">
                          Student login here?<a href="student/studentlogin.jsp" style="font-family:'Play', sans-serif;" style="color:blue">&nbsp;Login</a>
                          </p>
